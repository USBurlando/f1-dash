...
start "F1 Realtime ^| port 4001" cmd /k "title F1 Realtime ^| port 4001&&set RUST_LOG=info&&set ADDRESS=0.0.0.0:4001&&set ORIGIN=http://localhost:3001&&cargo run -p realtime"
